...
impl std::fmt::Debug for OrtApi {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("OrtApi").finish()
    }
}
#[test]
...
impl NNAPIFlags {
    pub const NNAPI_FLAG_LAST: NNAPIFlags = NNAPIFlags::NNAPI_FLAG_CPU_DISABLED;
}
#[repr(u32)]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
pub enum NNAPIFlags {
...
pub struct OnnxRuntime {
    ...
    pub arc4random_buf: Result<
        unsafe extern "C" fn(__buf: *mut ::std::os::raw::c_void, __nbytes: size_t),
        ::libloading::Error,
    >,
    ...
    >,
    pub strnlen: Result<
        unsafe extern "C" fn(__s1: *const ::std::os::raw::c_char, __n: size_t) -> size_t,
        ::libloading::Error,
    >,
    ...
    pub OrtSessionOptionsAppendExecutionProvider_CoreML: Result<
        unsafe extern "C" fn(options: *mut OrtSessionOptions, coreml_flags: u32) -> OrtStatusPtr,
        ::libloading::Error,
    >,
    pub OrtSessionOptionsAppendExecutionProvider_Nnapi: Result<
        unsafe extern "C" fn(options: *mut OrtSessionOptions, nnapi_flags: u32) -> OrtStatusPtr,
        ::libloading::Error,
    >,
...
impl OnnxRuntime {
        ...
        P: AsRef<::std::ffi::OsStr>,
    {
        ...
        let OrtSessionOptionsAppendExecutionProvider_CoreML = __library
            .get(b"OrtSessionOptionsAppendExecutionProvider_CoreML\0")
            .map(|sym| *sym);
        let OrtSessionOptionsAppendExecutionProvider_Nnapi = __library
            .get(b"OrtSessionOptionsAppendExecutionProvider_Nnapi\0")
            .map(|sym| *sym);
    ...
    > {
        let sym = self.signal.as_ref().expect("Expected function, got error.");
        (sym)(arg1, arg2)
    }
    ...
    pub unsafe fn wait(&self, arg1: *mut ::std::os::raw::c_int) -> pid_t {
        let sym = self.wait.as_ref().expect("Expected function, got error.");
        (sym)(arg1)
    }
    ...
    pub unsafe fn waitid(
        ...
        let sym = self.waitid.as_ref().expect("Expected function, got error.");
        (sym)(arg1, arg2, arg3, arg4)
    }
    pub unsafe fn wait3(
        &self,
        arg1: *mut ::std::os::raw::c_int,
        ...
        let sym = self.wait3.as_ref().expect("Expected function, got error.");
        (sym)(arg1, arg2, arg3)
    }
    pub unsafe fn wait4(
        &self,
        ...
        let sym = self.wait4.as_ref().expect("Expected function, got error.");
        (sym)(arg1, arg2, arg3, arg4)
    }
    pub unsafe fn alloca(&self, arg1: ::std::os::raw::c_ulong) -> *mut ::std::os::raw::c_void {
        let sym = self.alloca.as_ref().expect("Expected function, got error.");
        (sym)(arg1)
    }
    ...
    pub unsafe fn valloc(&self, arg1: size_t) -> *mut ::std::os::raw::c_void {
        let sym = self.valloc.as_ref().expect("Expected function, got error.");
        (sym)(arg1)
    }
    ...
    pub unsafe fn bsearch(
        ...
        let sym = self
            ...
            .as_ref()
            .expect("Expected function, got error.");
        (sym)(__key, __base, __nel, __width, __compar)
    }
    ...
    pub unsafe fn qsort(
        ...
        (sym)(__base, __nel, __width, __compar)
    }
    ...
    pub unsafe fn a64l(&self, arg1: *const ::std::os::raw::c_char) -> ::std::os::raw::c_long {
        let sym = self.a64l.as_ref().expect("Expected function, got error.");
        (sym)(arg1)
    }
    ...
    pub unsafe fn ecvt(
        ...
        let sym = self.ecvt.as_ref().expect("Expected function, got error.");
        (sym)(arg1, arg2, arg3, arg4)
    }
    ...
    pub unsafe fn fcvt(
        ...
        let sym = self.fcvt.as_ref().expect("Expected function, got error.");
        (sym)(arg1, arg2, arg3, arg4)
    }
    pub unsafe fn gcvt(
        &self,
        ...
        let sym = self.gcvt.as_ref().expect("Expected function, got error.");
        (sym)(arg1, arg2, arg3)
    }
    ...
    pub unsafe fn l64a(&self, arg1: ::std::os::raw::c_long) -> *mut ::std::os::raw::c_char {
        let sym = self.l64a.as_ref().expect("Expected function, got error.");
        (sym)(arg1)
    }
    ...
    pub unsafe fn setkey(&self, arg1: *const ::std::os::raw::c_char) -> () {
        let sym = self.setkey.as_ref().expect("Expected function, got error.");
        (sym)(arg1)
    }
    ...
    pub unsafe fn daemon(
        ...
        let sym = self.daemon.as_ref().expect("Expected function, got error.");
        (sym)(arg1, arg2)
    }
    ...
    pub unsafe fn psort(
        ...
        let sym = self.psort.as_ref().expect("Expected function, got error.");
        (sym)(__base, __nel, __width, __compar)
    }
    ...
    pub unsafe fn psort_r(
        ...
        let sym = self
            ...
            .as_ref()
            .expect("Expected function, got error.");
        (sym)(__base, __nel, __width, arg1, __compar)
    }
    ...
    pub unsafe fn radixsort(
        ...
        let sym = self
            ...
            .as_ref()
            .expect("Expected function, got error.");
        (sym)(__base, __nel, __table, __endbyte)
    }
    ...
    pub unsafe fn strtoq(
        ...
        let sym = self.strtoq.as_ref().expect("Expected function, got error.");
        (sym)(__str, __endptr, __base)
    }
    ...
    pub unsafe fn strerror_r(
        ...
        let sym = self
            ...
            .as_ref()
            .expect("Expected function, got error.");
        (sym)(__errnum, __strerrbuf, __buflen)
    }
    ...
    pub unsafe fn strnlen(&self, __s1: *const ::std::os::raw::c_char, __n: size_t) -> size_t {
        let sym = self
            .strnlen
            .as_ref()
            .expect("Expected function, got error.");
    ...
    pub unsafe fn memmem(
        ...
        (sym)(__big, __big_len, __little, __little_len)
    }
    ...
    pub unsafe fn swab(
        ...
        let sym = self.swab.as_ref().expect("Expected function, got error.");
        (sym)(arg1, arg2, arg3)
    }
    ...
    pub unsafe fn bcmp(
        ...
        let sym = self.bcmp.as_ref().expect("Expected function, got error.");
        (sym)(arg1, arg2, arg3)
    }
    pub unsafe fn bcopy(
        &self,
        ...
        let sym = self.bcopy.as_ref().expect("Expected function, got error.");
        (sym)(arg1, arg2, arg3)
    }
    pub unsafe fn bzero(
        &self,
        ...
        let sym = self.bzero.as_ref().expect("Expected function, got error.");
        (sym)(arg1, arg2)
    }
    pub unsafe fn index(
        &self,
        ...
        let sym = self.index.as_ref().expect("Expected function, got error.");
        (sym)(arg1, arg2)
    }
    pub unsafe fn rindex(
        ...
        let sym = self.rindex.as_ref().expect("Expected function, got error.");
        (sym)(arg1, arg2)
    }
    pub unsafe fn ffs(&self, arg1: ::std::os::raw::c_int) -> ::std::os::raw::c_int {
        let sym = self.ffs.as_ref().expect("Expected function, got error.");
        (sym)(arg1)
    }
    ...
    pub unsafe fn ffsl(&self, arg1: ::std::os::raw::c_long) -> ::std::os::raw::c_int {
        let sym = self.ffsl.as_ref().expect("Expected function, got error.");
        (sym)(arg1)
    }
    pub unsafe fn ffsll(&self, arg1: ::std::os::raw::c_longlong) -> ::std::os::raw::c_int {
        let sym = self.ffsll.as_ref().expect("Expected function, got error.");
        (sym)(arg1)
    }
    pub unsafe fn fls(&self, arg1: ::std::os::raw::c_int) -> ::std::os::raw::c_int {
        let sym = self.fls.as_ref().expect("Expected function, got error.");
        (sym)(arg1)
    }
    pub unsafe fn flsl(&self, arg1: ::std::os::raw::c_long) -> ::std::os::raw::c_int {
        let sym = self.flsl.as_ref().expect("Expected function, got error.");
        (sym)(arg1)
    }
    pub unsafe fn flsll(&self, arg1: ::std::os::raw::c_longlong) -> ::std::os::raw::c_int {
        let sym = self.flsll.as_ref().expect("Expected function, got error.");
        (sym)(arg1)
    }
    ...
    pub unsafe fn OrtSessionOptionsAppendExecutionProvider_CoreML(
        &self,
        options: *mut OrtSessionOptions,
        coreml_flags: u32,
    ) -> OrtStatusPtr {
        let sym = self
            ...
            .as_ref()
            .expect("Expected function, got error.");
        (sym)(options, coreml_flags)
    }
    pub unsafe fn OrtSessionOptionsAppendExecutionProvider_Nnapi(
        &self,
        options: *mut OrtSessionOptions,
        nnapi_flags: u32,
    ) -> OrtStatusPtr {
